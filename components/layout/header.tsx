        ...
        >
            <Container size="full" className="flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2 group">
                    {/* Using text fallback as primary per design system 'Serif-based wordmark' description, 
              but loading SVG if user prefers. 
              Here I implemented the text version to match 'The Voice' perfectly. 
          */}
